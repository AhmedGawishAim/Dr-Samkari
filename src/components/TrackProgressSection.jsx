                ...
                <div className="w-[100%] xl:w-[90%] mx-auto h-[640px]">
                    ...
                    <div className=" relative mx-auto w-[90%] left-0 h-full">
                        ...
                        <motion.div
                            ...
                            className="absolute left-0 inset-0 bg-white/60 rounded-[68px] z-2 border-white/50"
                        >
                        </motion.div>
                                ...
                                <motion.div
                                    ...
                                    <div className="box-image relative h-full">
                                        ...
                                        <div className=" absolute left-[40px]  grid grid-cols-[auto_1fr] items-center gap-3  top-[0px] w-full h-full">
                                            <h2 className="left text-xl text-gray-500 font-medium"> JALUPRO</h2>
                                            <div className="right  ">
                                                <div className="box-top w-[50%] pt-2">
                                                    <Test />
                                                </div>
                                                <div className="text-white text-[15px] pt-1">SuperHYDRO From Jalupro (1st)</div>
                        ...
                        >
                            ...
                            <div className="content-box absolute bottom-[20px]  w-[100%]  text-4xl overflow-hidden text-black">
                                <div className=" pe-14 pb-10 flex flex-col justify-center items-end" ref={ref}>
                                    ...
                                    >
                                        <div className="text-5xl"> Track <span className="text-6xl font-bold"> Progress,</span> </div>
                                        <div className="text-5xl">  Like Never Before  </div>
                                    </motion.div>


                                    <motion.div
                                        className="mt-5 text-3xl lg:w-[50%] text-end"
                                        initial="hidden"
                                        animate={controls}
