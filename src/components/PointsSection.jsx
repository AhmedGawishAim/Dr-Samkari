      ...
      <div className="container mx-auto">
        <div className="content flex flex-col items-center">
          ...
          <div className="box-text w-[80%] lg:w-[60%] text-center space-y-6">
            ...
            >
              <span className="text-7xl "> Points That <span className='font-bold'>Pay Off</span></span>
            </motion.h1>
          ...
          <div className="box-phone relative mt-[550px] w-full h-full">
            {/* Phone */}
            <motion.div
            ...
            <motion.div
              ...
              viewport={{ once: false }}
              className="absolute left-0 !top-[-330px] w-full flex justify-center z-50"
            >
              <Image
                src={ImgDimond}
                alt="Diamond"
