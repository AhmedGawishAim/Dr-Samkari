...
const ballConfigs = [
    { left: '10%', bubbleMoveX: "330px", bubbleMoveXSmall: "150px", bubbleMoveY: "-200px", bubbleMoveYSmall: "-100px", top: '0%', width: 100, widthSmall: 50, delay: 0.4 },
    { left: '60%', bubbleMoveX: "-230px", bubbleMoveXSmall: "-100px", bubbleMoveY: "-200px", bubbleMoveYSmall: "-100px", top: '15%', width: 90, widthSmall: 45, delay: 0.4 },
